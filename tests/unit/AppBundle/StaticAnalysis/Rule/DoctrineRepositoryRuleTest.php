...
final class DoctrineRepositoryRuleTest extends RuleTestCase
{
    ...
    public function testRule(): void
    {
        $this->analyse([__DIR__ . '/../../../../stubs/phpstan/Doctrine/SomeExampleClass.php'], [
            ...
            ['Calling method findBy() outside of repository classes is not allowed.', 22],
            ['Calling method findOneBy() outside of repository classes is not allowed.', 23],
            ...
            ['Calling method findBy() outside of repository classes is not allowed.', 30],
            ['Calling method findOneBy() outside of repository classes is not allowed.', 31],
