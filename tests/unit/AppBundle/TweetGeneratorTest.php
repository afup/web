...
use AppBundle\VideoNotifier\TweetGenerator;
use PHPUnit\Framework\TestCase;

final class TweetGeneratorTest extends TestCase
{
    /**
     * @dataProvider generateDateProvider
     */
    public function testGenerate($talkInfos, $speakersInfos, $expected): void
    {
        $speakers = [];
        ...
        $actual = $generator->generate($talk, $speakers);
    ...
    public function generateDateProvider(): array
    {
        return [
            ...
            "On change la formulation si le titre + compte twitter sont trop longs. De plus on ne met pas de point si il y  un point d'explamation a la fin du titre" => [
                'talk' => [
                    'id' => 1941,
            ...
            "On ne met pas de point si point d'interogation à la fin + pas de twitter" => [
                'talk' => [
                    'id' => 1941,
            ...
            "Deux speakers sans tweet a raccourcir" => [
                'talk' => [
                    'id' => 1903,
            ...
            "Titre long et un grand nombre de speakers" => [
                'talk' => [
                    'id' => 1609,
            ...
            "On évite d'avoir deux espaces à la suite" => [
                'talk' => [
                    'id' => 1295,
            ...
            "Speaker avec compte twitter ayant une URL complète en http" => [
                'talk' => [
                    'id' => 2314,
            ...
            "Speaker avec compte twitter ayant une URL complète en https" => [
                'talk' => [
                    'id' => 2314,
                    'title' => 'Les hexagones de la Ruche qui dit Oui !',
                ],
    ...
    public function testGenerateWithFullEntities(): void
    {
        ...
        $tweet = $generator->generate($talk, [$speaker]);

        self::assertEquals(
            "Utiliser PostgreSQL en 2014. La conférence de @tapoueh à revoir sur le site de l'AFUP : https://afup.org/talks/1007-utiliser-postgresql-en-2014",
            $tweet,
        );
    }
}
