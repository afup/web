Feature: Administration - Partie Personnes morales - cotisations
  ...
  Scenario: On test la gestion des cotisations
    ...
    When I fill in "membership_fee[montant]" with "152"
    ...
    When I fill in "membership_fee[montant]" with "150"
    And I select "0" from "membership_fee[typeReglement]"
    When I fill in "membership_fee[informationsReglement]" with "notes du réglement"
    When I fill in "membership_fee[referenceClient]" with "42"
    And I fill in "membership_fee[dateDebut]" with "2022-03-05"
    And I fill in "membership_fee[dateFin]" with "2023-03-05"
    And I press "Ajouter"
    ...
    When I follow the button of tooltip "Modifier la cotisation"
    Then I should see "Modifier une cotisation"
    And I select "Chèques" from "membership_fee[typeReglement]"
    And I fill in "membership_fee[informationsReglement]" with "42"
    And I press "Modifier"
    Then I should see "La cotisation pour MyCorp a bien été modifiée"
    ...
    When I follow the button of tooltip "Modifier la cotisation"
    Then I should see "Modifier une cotisation"
    And I select "Virement" from "membership_fee[typeReglement]"
    And I fill in "membership_fee[informationsReglement]" with "8342"
    And I press "Modifier"
    Then I should see "La cotisation pour MyCorp a bien été modifiée"
    ...
    When I follow the button of tooltip "Modifier la cotisation"
    Then I should see "Modifier une cotisation"
    And I select "En ligne" from "membership_fee[typeReglement]"
    And I fill in "membership_fee[informationsReglement]" with ""
    And I press "Modifier"
    Then I should see "La cotisation pour MyCorp a bien été modifiée"
