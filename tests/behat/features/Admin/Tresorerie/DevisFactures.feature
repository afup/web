Feature: Administration - Trésorerie - Devis/Facture
  ...
  Scenario: Créer/Modifier un devis, une facture
    ...
    Then I should see "Ajouter un devis"
    And the "quotation[company]" field should contain "ESN dev en folie"
    And the "quotation[address]" field should contain "1 rue du chemin"
    ...
    When I fill in "quotation[company]" with "ESN copie folie"
    ...
    And I fill in "quotation[details][2][quantity]" with "1"
    And I fill in "quotation[details][2][unitPrice]" with "500"
    When I press "Modifier" and wait until I see "L'écriture a été modifiée"
    Then I should see "L'écriture a été modifiée"
