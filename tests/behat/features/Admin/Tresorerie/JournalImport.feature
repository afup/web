Feature: Administration - Trésorerie - Journal import
  ...
  Scenario: Test d'import du fichier
    ...
    Then The "transaction[evenement]" field should have the following selected text "Association AFUP"
    Then The "transaction[categorie]" field should have the following selected text "Meetup"
    # Test Twilio
    When I move backward one page
    When I follow the button of tooltip "Modifier la ligne CB Twilio SZ5KZ54M FACT 090223 DONT FRAIS DE COMM. 0,26 EUR"
    Then I should see "Modifier une écriture"
    Then The "transaction[evenement]" field should have the following selected text "Association AFUP"
    Then The "transaction[categorie]" field should have the following selected text "Outils"
