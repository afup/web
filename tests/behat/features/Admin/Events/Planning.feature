Feature: Administration - Évènements - Planning des sessions
  ...
  Scenario: Accès au planning des session(s)
    ...
    And I fill in "form[start]" with "2025-11-12T10:30"
    And I fill in "form[end]" with "2025-11-12T11:30"
    And I press "Soumettre"
    Then I should see "Le planning de la session a été modifié"
