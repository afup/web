    ...
    public function run(): void
    {
        ...
        $data = [
            ...
            [
                ...
                // Prix du token visiteur de test (db/seeds/TokensVisiteurs.php : price = 100)
                'montant' => 100.0,
                'genre' => Genre::Homme->value,
                'nom' => 'Visiteur',
                'prenom' => 'Vincent',
                ...
                'id_forum' => Event::ID_FORUM,
                'member_type' => MemberType::MemberPhysical->value,
                'special_price_token' => TokensVisiteurs::TOKEN_100,
                'etat' => Ticket::STATUS_PAID,
            ],
            [
                'date' => time(),
                ...
                'type_inscription' => Ticket::TYPE_SPECIAL_PRICE,
                // Prix du token visiteur de test (db/seeds/TokensVisiteurs.php : price = 120)
                'montant' => 120.0,
                'genre' => Genre::Femme->value,
                'nom' => 'Visiteuse',
                'prenom' => 'Valérie',
                ...
                'id_forum' => Event::ID_FORUM,
                'member_type' => MemberType::MemberPhysical->value,
                'special_price_token' => TokensVisiteurs::TOKEN_120,
                'etat' => Ticket::STATUS_PAID,
            ],
            [
                'date' => time(),
