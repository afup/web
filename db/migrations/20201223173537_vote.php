...
class Vote extends AbstractMigration
{
    ...
    {
        $sql = <<<SQL
DROP TABLE IF EXISTS `afup_assemblee_generale_vote`;

CREATE TABLE `afup_assemblee_generale_vote` (
...
ALTER TABLE `afup_vote_assemblee_generale` ADD CONSTRAINT const_question FOREIGN KEY (`afup_assemblee_generale_question_id`) REFERENCES afup_assemblee_generale_vote (`id`);
SQL;
