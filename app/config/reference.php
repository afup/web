 ...
 *     }>,
 * }
 * @psalm-type TingConfig = array{
 *     cache_file?: scalar|Param|null, // Default: "ting.3.9.0.php"
 *     cache_provider?: scalar|Param|null,
 *     configuration_resolver_service?: scalar|Param|null, // If provided, this service will receive the configuration at boot time and can alter it. // Default: null
 *     repositories?: list<array{ // Default: []
 *         namespace?: scalar|Param|null,
 *         directory?: scalar|Param|null,
 *         glob?: scalar|Param|null, // Default: "*Repository.php"
 *         options?: list<array{ // Default: []
 ...
 *         }>,
 *     }>,
 *     databases_options?: list<array{ // Default: []
 *         timezone?: scalar|Param|null,
 *     }>,
 * }
 ...
 *     }>,
 * }
 * @psalm-type TiimeNewRelicConfig = array{
 *     enabled?: bool|Param, // Default: true
 *     interactor?: scalar|Param|null,
 *     twig?: bool|Param, // Default: true
 *     api_key?: scalar|Param|null, // Default: null
 *     api_host?: scalar|Param|null, // Default: null
 *     license_key?: scalar|Param|null, // Default: null
 *     application_name?: scalar|Param|null, // Default: null
 *     deployment_names?: list<scalar|Param|null>,
 *     xmit?: scalar|Param|null, // Default: false
 *     logging?: bool|Param, // Write logs to a PSR3 logger whenever we send data to NewRelic. // Default: false
 *     exceptions?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *     },
 *     commands?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *         ignored_commands?: list<scalar|Param|null>,
 *     },
 *     deprecations?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *     },
 *     http?: bool|array{
 *         enabled?: bool|Param, // Default: true
 *         transaction_naming?: scalar|Param|null, // Default: "route"
 *         transaction_naming_service?: scalar|Param|null, // Default: null
 *         ignored_routes?: list<scalar|Param|null>,
 *         ignored_paths?: list<scalar|Param|null>,
 *         using_symfony_cache?: scalar|Param|null, // Default: false
 *     },
 *     instrument?: bool|Param, // Default: false
 *     monolog?: bool|array{
 *         enabled?: bool|Param, // Default: false
 *         channels?: string|array{
 *             type?: scalar|Param|null,
 *             elements?: list<scalar|Param|null>,
 *         },
 *         level?: scalar|Param|null, // Default: "error"
 *         service?: scalar|Param|null, // Default: "tiime.new_relic.monolog_handler"
 *     },
 * }
