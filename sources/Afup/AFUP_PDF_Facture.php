...
{
    /**
     * The AFUP_Configuration object
     *
     * @var AFUP_Configuration
     *
     * @access protected
     */
    ...
    /**
     * Set the AFUP_Configuration object
     *
     * @param AFUP_Configuration $configuration The AFUP_Configuration object
     * @return void
     * @throws Exception
    ...
    {
        if (!is_object($configuration) || !($configuration instanceOf AFUP_Configuration))
        {
            throw new Exception('$configuration parameter must be an instance of AFUP_Configuration class');
        }
