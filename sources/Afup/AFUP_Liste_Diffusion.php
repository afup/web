...
// ezmlm-idx pour le logiciel de la gestion de la liste
     ...
     * @return boolean
     **/
    function abonnement_verifier($email,$liste,$admin) {
     ...
     * @return boolean
     **/
    function abonnement_souscrire($email, $liste, $admin) {
        trigger_error("en cours");
    }
    /**
     ...
     * @return boolean
     **/
    function abonnement_resilier($email, $liste, $admin) {
        trigger_error("en cours");
    }
    /**
     * @var $email le courriel de la personne
     * @var $liste le courriel de la liste
     * @var $admin de quoi prouver que l'admin est vraiement admin
     * @return array liste des courriels dans la liste.
     **/
    function abonnements_lister ($liste,$admin) {
        trigger_error("en cours");
    }
