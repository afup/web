...
class Article
{
    ...
    #[ORM\Column(name: 'id_site_rubrique', nullable: true)]
    public ?int $rubricId = null;

    #[ORM\Column(name: 'titre', nullable: true)]
    public ?string $title = null;

    #[ORM\Column(name: 'raccourci', nullable: true)]
    ...
    #[ORM\Column(name: 'type_contenu', nullable: true)]
