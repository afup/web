...
use AppBundle\Controller\Admin\Membership\MembershipFeePaymentEnum;
...
class MembershipFee implements NotifyPropertyInterface
{
    ...
    private ?int $id = null;
    private ?MemberTypeEnum $userType = null;
    private ?int $userId = null;
    private ?float $amount = null;
    private ?MembershipFeePaymentEnum $paymentType = null;
    ...
    public function getUserType(): ?MemberTypeEnum
    {
        return $this->userType;
    }

    public function setUserType(?MemberTypeEnum $userType): self
    {
    ...
    public function getPaymentType(): ?MembershipFeePaymentEnum
    {
        return $this->paymentType;
    }

    public function setPaymentType(?MembershipFeePaymentEnum $paymentType): self
    {
