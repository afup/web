...
{
    public function getMembershipStartingDate(MemberTypeEnum $memberType, int $idMember)
    {
    ...
    public static function initMetadata(SerializerFactoryInterface $serializerFactory, array $options = [])
    {
        ...
        $metadata
            ...
            ->addField([
                ...
                'serializer_options' => [
                    'unserialize' => ['enum' => MemberTypeEnum::class],
                ],
            ])
            ->addField([
            ...
            ->addField([
                ...
                'serializer' => BackedEnum::class,
                'serializer_options' => [
                    'unserialize' => ['enum' => MembershipFeePaymentEnum::class],
                ],
            ])
            ->addField([
