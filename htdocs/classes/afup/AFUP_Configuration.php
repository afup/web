...
class AFUP_Configuration
{
     ...
     * @return void
     */
    function AFUP_Configuration($chemin_fichier)
    {
     ...
     *
     * Cette méthode effectue la transformation inverse de celle effectuée par la méthode AFUP_Configuration::_genererValeurs.
     *
     ...
     */
    function _genererChemins($tableau, &$chemins, $parent = '') {
     ...
     *
     * Cette méthode effectue la transformation inverse de celle effectuée par la méthode AFUP_Configuration::_genererChemins.
     *
     * Exemple de fonctionnement :
     * $chemins = array('a'    => 'pomme',
     *                  'b|ba' => 'poire',
