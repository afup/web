...
$pdf->Cell(0,5,recup_budget_evenement($idevenement),0,0,'C');

//if ($idevenement) $filtre_idevenement=" AND a.idevenement='$idevenement'  "; else $filtre_idevenement=" ";
/*
...
"; 
*/
$sql="SELECT a.*,b.id,b.categorie 
	   FROM compta_simulation a, budget_categorie b 
	   WHERE a.idoperation='1' 
	         AND a.idevenement=$idevenement 
