...
if ($action == 'lister') {
    ...
    $formulaire->addElement('text'    , 'SiteWeb'            , $annuairepro_membres->retoucherSiteWeb($champs['SiteWeb'], 'Site web') , array('size' => 30, 'maxlength' => 100));
    ...
    $formulaire->addElement('header'  , ''                   , 'Paramtres');
